...
export const translations = {
    vi: {
        ...
        activeKeyLabel: 'Commercial License',
        activeKeyPlaceholder: 'Nhập mã kích hoạt (Ví dụ: TEST_...)',
        activeKeyHelp: 'Mã kích hoạt giúp bạn mở khóa các tính năng thương mại.',
        licenseStatus: 'Trạng thái License',
        statusActive: 'Đang hoạt động',
        statusExpired: 'Đã hết hạn',
        statusInvalid: 'Không hợp lệ',
        expiryDate: 'Ngày hết hạn',
        licenseUser: 'Đăng ký bởi',
        daysRemaining: 'Còn lại', // New
        licenseExpired: 'LICENSE ĐÃ HẾT HẠN', // New
    ...
    en: {
        ...
        activeKeyLabel: 'Commercial License',
        activeKeyPlaceholder: 'Enter license key (e.g. TEST_...)',
        activeKeyHelp: 'License key unlocks commercial features.',
        licenseStatus: 'License Status',
        statusActive: 'Active',
        statusExpired: 'Expired',
        statusInvalid: 'Invalid',
        expiryDate: 'Expires On',
        licenseUser: 'Registered To',
